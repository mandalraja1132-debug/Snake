...
# questions=[
#     ["Ceo of chat gpt?", "Sunder pichai","Elon Musk","Sam Altman","Aravind Srinivas ", 3],
#     ["Who is the founder of Microsoft?", "Steve Jobs", "Bill Gates", "Elon Musk", "Larry Page", 2],
...
#     ["Who is the current CEO of Meta?", "Mark Zuckerberg", "Sam Altman", "Sundar Pichai", "Andy Jassy", 1],
...
#     ["Which Indian scientist is known as the 'Missile Man of India'?", "C. V. Raman", "A. P. J. Abdul Kalam", "Homi Bhabha", "Vikram Sarabhai", 2],

#     ["Which company owns LinkedIn?", "Google", "Amazon", "Microsoft", "Apple", 3],

#     ["How many bones are there in an adult human body?", "206", "208", "201", "212", 1],
...
#     print(f"4. {q[4]}") 
#     # check answer
#     a=int(input("enter your option : 1/2/3/4 :  " ))
#     if q[5]==a:
#         print("correct ans")
#         point+=10
#     else:
#         print("Wrong",q[5],"is the Answer")
